...
$ movement  init
```
you will get a ".movement" folder in your current folder.
```shell
config.yaml
profiles:
  default:
...
2. Get test MVMT
```shell
$ movement account  fund-with-faucet --account your_original_account --amount 100000000
```
3. Create your resource account
```shell
$ movement move run --function-id '0x1::resource_account::create_resource_account_and_fund' --args 'string:any string you want' 'hex:your_original_account' 'u64:10000000'
```
4. Get your resource eaccount 
```shell
$ movement account list --account your_original_account
```

Or find it on explorer: https://explorer.movementlabs.xyz/account/your_original_account
...
[addresses]
razor = "71e609393d30dfacaf477c9a9cd7824ae14b5f8d2a20c0b1917325d41e4a4aac" //replace this with your_resource_account 
dev = "2e5cc2bff22d15be32613aace67b7386251b8ae808a99241ee34b4703f780e2c" // replace this with your_original_account which you created the resource account 
