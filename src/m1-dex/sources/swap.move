...
module razor::RazorSwapPool {
    ...
    #[test(creator = @razor, resource_account = @razor_resource, someone_else = @0x11)]
    public entry fun test_add_remove_liquidity_basic_1_1(creator: &signer, resource_account: &signer, someone_else: &signer) 
        ...
        // should takes 10000/10000 coin and gives 9000 LPCoin (RazorPoolLibrary::sqrt(10000*10000)-1000)
    ...
    public entry fun test_add_remove_liquidity_basic_1_100(creator: &signer, resource_account: &signer, someone_else: &signer) 
        ...
        // should takes 1000/100000 coin and gives 9000 LPCoin (RazorPoolLibrary::sqrt(1000*100000)-1000)
    ...
    public entry fun test_add_remove_liquidity_basic_1_2(creator: &signer, resource_account: &signer, someone_else: &signer) 
        ...
        // should takes 1000/2000 coin and gives 414 LPCoin (RazorPoolLibrary::sqrt(1000*2000)-1000)
    ...
    #[test(creator = @razor, resource_account = @razor_resource, someone_else = @0x11, dao_fee_to = @0x99)]
    ...
    public entry fun test_resource_account(deployer: &signer) {
        ...
        assert!(addr == @razor_resource, TEST_ERROR);
    }

    // borrow on boin and repay the other coin, greater than swap fee
    // borrow BTC and repay USDT
    #[test(creator = @razor, resource_account = @razor_resource, someone_else = @0x11, another_one = @0x12)]
